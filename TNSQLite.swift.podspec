Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/liyuan116/TNSQLite.swift.git"
  s.license          = 'MIT'
  s.author           = { "Stephen Celis" => "stephen@stephencelis.com" }
  s.source           = { :git => "https://github.com/liyuan116/TNSQLite.swift.git", :tag => s.version.to_s }
